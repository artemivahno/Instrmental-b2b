...
import com.itacademy.jd2.ai.b2b.web.util.XMLResourceBundleControl;
...
public class I18N extends SimpleTagSupport {
    ...
    private String getLocalized(final String key, final Locale locale) {
        ...
        final ResourceBundle bundle = ResourceBundle.getBundle("i18n/translations",
                locale, new XMLResourceBundleControl());
