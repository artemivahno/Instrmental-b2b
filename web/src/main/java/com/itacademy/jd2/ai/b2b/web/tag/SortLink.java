package com.itacademy.jd2.ai.b2b.web.tag;
...
import com.itacademy.jd2.ai.b2b.web.dto.list.SortDTO;
...
public class SortLink extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException {
        ...
        final ListDTO<?> listDTO = (ListDTO<?>) getJspContext()
                .findAttribute(ListDTO.SESSION_ATTR_NAME);
        if (listDTO == null) {
            throw new IllegalArgumentException(
                    "context should have required attribute in session:"
                            + ListDTO.SESSION_ATTR_NAME);
        }
        ...
        jspContext.getOut().println(String.format("<a href=\"%s\">%s%s</a>", href,
                tagBodyWriter.toString(), sortIcon));
    }
