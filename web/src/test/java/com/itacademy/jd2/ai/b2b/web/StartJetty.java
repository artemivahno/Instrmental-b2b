package com.itacademy.jd2.ai.b2b.web;
...
public final class StartJetty {
    ...
    private static void startInstance(final int port) throws MalformedURLException {
        ...
        final Configuration[] configurations = new Configuration[] {
                new WebInfConfiguration(), envConfiguration, new WebXmlConfiguration() };
