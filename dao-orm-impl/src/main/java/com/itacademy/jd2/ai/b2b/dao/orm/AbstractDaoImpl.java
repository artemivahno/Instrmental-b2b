...
import com.itacademy.jd2.ai.b2b.dao.api.BaseDao;
import com.itacademy.jd2.ai.b2b.dao.api.filter.AbstractFilter;
...
public abstract class AbstractDaoImpl<T, ID> implements BaseDao<T, ID> {
    ...
    public List<T> selectAll() {
        final CriteriaQuery<? extends T> query = entityManager.getCriteriaBuilder()
    ...
    public void delete(final ID id) {
        entityManager
                .createQuery(String.format("delete from %s e where e.id = :id",
    ...
    public void deleteAll() {
        entityManager
                .createQuery(String.format("delete from %s", entityClass.getSimpleName()))
                .executeUpdate();
